...
public class RequestAriakekuro implements Serializable {
    private String tanggalariakekuro, jumlahariakekuro, waktuariakekuro;

    public RequestAriakekuro() {
    }

    public RequestAriakekuro(String tanggalariakekuro, String jumlahariakekuro, String waktuariakekuro) {
