...
public class RequestUpdateAzomit implements Serializable {
    private String tanggalazomit, jumlahazomit, waktuazomit;

    public RequestUpdateAzomit() {
    }

    public RequestUpdateAzomit(String tanggalazomit, String jumlahazomit, String waktuazomit) {
