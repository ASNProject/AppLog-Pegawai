...
public class RequestDataSampling implements Serializable {
    private String  tanggalsampling, jumlahtebarsamplings, mbw, pakanseharisampling, totalpakansampling, fr, populasi, adgmingguan, biomass, sp, konsumsifeed, fcr, usia;

    public RequestDataSampling() {
    }

    public RequestDataSampling(String tanggalsampling, String jumlahtebarsamplings, String mbw, String pakanseharisampling, String totalpakansampling, String fr, String populasi, String adgmingguan, String biomass, String sp, String konsumsifeed, String fcr, String usia) {
