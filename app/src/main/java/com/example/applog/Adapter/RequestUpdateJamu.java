...
public class RequestUpdateJamu implements Serializable {
    private String tanggaljamu, jumlahjamu, waktujamu;

    public RequestUpdateJamu() {
    }

    public RequestUpdateJamu(String tanggaljamu, String jumlahjamu, String waktujamu) {
