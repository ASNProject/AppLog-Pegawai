...
public class RequestKaptan implements Serializable {
    private String tanggalkaptan, jumlahkaptan, waktukaptan;

    public RequestKaptan() {
    }

    public RequestKaptan(String tanggalkaptan, String jumlahkaptan, String waktukaptan) {
