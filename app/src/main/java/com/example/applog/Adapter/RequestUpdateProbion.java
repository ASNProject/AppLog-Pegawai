...
public class RequestUpdateProbion implements Serializable {
    private String tanggalprobion, jumlahprobion, waktuprobion;

    public RequestUpdateProbion() {
    }

    public RequestUpdateProbion(String tanggalprobion, String jumlahprobion, String waktuprobion) {
