...
public class RequestUpdateKCL implements Serializable {
    private String tanggalkcl, jumlahkcl, waktukcl;

    public RequestUpdateKCL() {
    }

    public RequestUpdateKCL(String tanggalkcl, String jumlahkcl, String waktukcl) {
