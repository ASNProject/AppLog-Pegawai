...
public class RequestDolomit implements Serializable {
    private String tanggaldolomit, jumlahdolomit, waktudolomit;

    public RequestDolomit() {
    }

    public RequestDolomit(String tanggaldolomit, String jumlahdolomit, String waktudolomit) {
